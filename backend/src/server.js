...
const sessionImagesPath = path.join(__dirname, '..', 'data', 'session_images');
if (!fs.existsSync(sessionImagesPath)) {
  fs.mkdirSync(sessionImagesPath, { recursive: true });
}
app.use('/session-images', express.static(sessionImagesPath));
